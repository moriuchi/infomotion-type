...
loadRadarChart.prototype.chart = function() {
...
loadRadarChart.prototype.draw = function(id, d, options) {
    var chart = this.chart().config(options);
