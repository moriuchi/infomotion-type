...
StackedQuantileChart.defaultSettings = {
    "legends":[
        {"key": "GROUP01"},
        {"key": "GROUP02"},
        {"key": "GROUP03"},
...
StackedQuantileChart.settings = EnebularIntelligence.SchemaProcessor([
        {
...
function StackedQuantileChart(settings, options) {
    var that = this;
    ...
    d3.select(this.el).attr('class', 'quantdiv');
...
StackedQuantileChart.prototype.onDrillDown = function(cb) {
    this.onDrillDownListener = cb;
}


StackedQuantileChart.prototype.addData = function(data) {
    var that = this;
...
StackedQuantileChart.prototype.clearData = function() {
    this.data = [];
    this.refresh();
}

StackedQuantileChart.prototype.calculate = function() {
    var that = this;
...
StackedQuantileChart.prototype.refresh = function() {
    var that = this;
...
StackedQuantileChart.prototype.getPoints = function(_, key, trans) {
...
StackedQuantileChart.prototype.mouseoverLegend = function(d) {
    this.transitionKey = d;
    this.refresh();
}

StackedQuantileChart.prototype.mouseoutLegend = function() {
    delete this.transitionKey;
    this.refresh();

}

StackedQuantileChart.prototype.resize = function(options) {
    var that = this;
...
StackedQuantileChart.prototype.getEl = function() {
  return this.el;
}

window.EnebularIntelligence.register('stacked-quantile-chart', StackedQuantileChart);

module.exports = StackedQuantileChart;
