...
var gaugechart = require('./halfgaugechart.js');

HalfGaugeChart.defaultSettings = {
    "label" : "lang",
    "value": "ss",
    "labelNames" : []
};

HalfGaugeChart.settings = EnebularIntelligence.SchemaProcessor([
        {
...
function HalfGaugeChart(settings, options) {
    var that = this;
...
HalfGaugeChart.prototype.onDrillDown = function(cb) {
    this.onDrillDownListener = cb;
}


HalfGaugeChart.prototype.addData = function(data) {
    var that = this;
...
HalfGaugeChart.prototype.clearData = function() {
    this.data = [];
    this.refresh( );
}

HalfGaugeChart.prototype.calculate = function() {
    var that = this;
    var newdata = {};
...
HalfGaugeChart.prototype.refresh = function() {
    var that = this;
...
HalfGaugeChart.prototype.resize = function(options) {
    var that = this;
...
HalfGaugeChart.prototype.getEl = function() {
  return this.el;
}

window.EnebularIntelligence.register('half-gauge-chart', HalfGaugeChart);

module.exports = HalfGaugeChart;
